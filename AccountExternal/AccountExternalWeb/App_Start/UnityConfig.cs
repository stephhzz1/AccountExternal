...
namespace AccountExternalWeb
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IDCredentialRole, DCredentialRole>(new PerRequestLifetimeManager());
            #endregion
            ...
            container.RegisterType<IFCredentialRole, FCredentialRole>(new PerRequestLifetimeManager());
            #endregion
        }
    }
}